...
![Скриншот главной страницы](./public/images/screenshot.jpg)
...
```bash
git clone https://github.com/yourusername/hahaton-vov.git
cd hahaton-vov
```
...
- Email: info@vov-project.ru
- Telegram: [@vov_project](https://t.me/vov_project)
